...
public class RobotMap {
    ...
    public static AnalogChannel driveTraindistanceToWall;
    public static AnalogChannel driveTrainlightSensorLeft;
    public static AnalogChannel driveTrainlightSensorRight;
    public static AnalogChannel shootingshooterAnglePot;
    public static Servo shootinglatchServo;
    public static SpeedController shootingwinchMotor;
    public static AnalogChannel shootingwinchPot;
    public static DigitalInput shootingshooterLimit;
    public static SpeedController pickuppickupWheels;
    public static AnalogChannel pickuparmPot;
    public static SpeedController pickuppickupArm;
    public static AnalogChannel pickuparmOffset;
