...
public class OI {
    ...
    public OI() {
        ...
        g2Button8.whileHeld(new ManualOverrideArm());
        g2Button7 = new JoystickButton(gamepad2, 7);
        g2Button7.whileHeld(new CenterIndexWheels());
        g2Button6 = new JoystickButton(gamepad2, 6);
        g2Button6.whenPressed(new OpenIndexWheels());
        ...
        g2Button4.whileHeld(new ManuallyAdjustPotValues());
