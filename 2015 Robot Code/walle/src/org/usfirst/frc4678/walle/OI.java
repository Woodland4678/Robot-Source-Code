...
public class OI {
    ...
    public OI() {
        ...
        g2Button6.whileHeld(new ReverseIndex());
        g2Button5 = new JoystickButton(gamepad2, 5);
        g2Button5.whenPressed(new RunIndexWheels());
        g2Button4 = new JoystickButton(gamepad2, 4);
        g2Button4.whenPressed(new ManualOverride());
        ...
        SmartDashboard.putData("Manual Override", new ManualOverride());

        SmartDashboard.putData("RunIndexWheels", new RunIndexWheels());

        SmartDashboard.putData("ReverseIndex", new ReverseIndex());
