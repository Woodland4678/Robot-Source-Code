...
public class Robot extends IterativeRobot {
    ...
    public static double lifterPower() {
        ...
        if (!prefs.containsKey("debugLevel")) {
            prefs.putDouble("debugLevel", 0.3);
        }
        return prefs.getDouble("debugLevel", 0.3);
    }
    public static double lifterUpperLimit() {
        Preferences prefs = Preferences.getInstance();
        if (!prefs.containsKey("debugLevel")) {
            prefs.putDouble("debugLevel", 75);
        }
        return prefs.getDouble("debugLevel", 75);
    }
    public static double lifterLowerLimit() {
        Preferences prefs = Preferences.getInstance();
        if (!prefs.containsKey("debugLevel")) {
            prefs.putInt("debugLevel", 10);
        }
        return prefs.getInt("debugLevel", 10);
    }
