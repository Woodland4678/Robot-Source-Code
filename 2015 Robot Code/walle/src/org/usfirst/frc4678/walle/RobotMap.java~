...
public class RobotMap {
    ...
    public static SpeedController indexWheelsIndexMotor;
    ...
    public static Servo trashMagnetlatchServo;
    public static SpeedController trashMagnetgarbageWinch;
    public static AnalogPotentiometer trashMagnetgarbagePosition;
    ...
    public static void init() {
        ...
        indexWheelsIndexMotor = new Victor(7);
        LiveWindow.addActuator("Index Wheels", "IndexMotor", (Victor) indexWheelsIndexMotor);
        ...
        trashMagnetlatchServo = new Servo(8);
        LiveWindow.addActuator("TrashMagnet", "latchServo", trashMagnetlatchServo);
        
        trashMagnetgarbageWinch = new Victor(0);
        LiveWindow.addActuator("TrashMagnet", "garbageWinch", (Victor) trashMagnetgarbageWinch);
        
        trashMagnetgarbagePosition = new AnalogPotentiometer(3, 1.0, 0.0);
        LiveWindow.addSensor("TrashMagnet", "garbagePosition", trashMagnetgarbagePosition);
