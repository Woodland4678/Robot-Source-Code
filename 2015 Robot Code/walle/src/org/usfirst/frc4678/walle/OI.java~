...
public class OI {
    ...
    public OI() {
        ...
        joystickButton1 = new JoystickButton(gamepad1, 2);
        joystickButton1.whenPressed(new TestingCommand());
        button1 = new JoystickButton(gamepad1, 1);
        button1.whenPressed(new TestingCommand());
        ...
        SmartDashboard.putData("TestingCommand", new TestingCommand());
