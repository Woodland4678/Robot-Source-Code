...
public class Claw extends Subsystem {
	...
	double clawTarget;
	boolean getStopped;
	int clawTargetDegreesToFloor = 0;
    ...
    public void resetClawEncoder(int value) {
    	clawStartingValue = value;
    }
    ...
    public void setClawTargetDegrees(int target) {
    	clawTargetDegreesToFloor = target;
    }
    
    public int getClawTargetDegrees() {
    	return clawTargetDegreesToFloor;
    }
