...
//--------------------------------------------------------------------------
    ...
    public boolean gyroTurn(double target) {
    	...
    	gyroPower = gyroError * 0.0047;
    	Robot.drivetrain.setMotor("left", -gyroPower);
    	Robot.drivetrain.setMotor("right", gyroPower);
    ...
    public boolean getAuton() { return Auton;}
    
    public void setAuton(boolean bVal) {
    	Auton = bVal;
    }
