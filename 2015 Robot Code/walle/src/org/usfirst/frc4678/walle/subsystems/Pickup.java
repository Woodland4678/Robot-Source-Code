...
public class Pickup extends Subsystem {
    ...
    public boolean lift(double target) {
    	...
    	switch(lifterState) {
    		case 0:
    			if((toteSensor1.get() == true) && (toteSensor2.get() == false) && target < Robot.pickup.getLifterHeight()) {
    				lifterState++;
    			}
    			else if((toteSensor1.get() == true) && (toteSensor2.get() == false) && target > Robot.pickup.getLifterHeight()) {
    				lifterState = lifterState + 2;
    			}
    			break;
    		case 1:
